# Generated by Django 4.2.20 on 2025-03-10 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escritorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colaboradores', to='app_users.escritorio')),
            ],
        ),
    ]
