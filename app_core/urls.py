...
urlpatterns = [
    ...
    path('painel/tickets/lista/', views.ticket_listar, name='ticket_listar'),  # Configura a rota 'ticket_listar'
    ...
    # path('painel/tickets/tarefas/criar/<int:ticket_number>/', views.criar_tarefa, name='criar_tarefa'),
